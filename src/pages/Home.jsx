...
const highlights = [
    {
        ...
        desc: 'A family member or senior supervisor inspects every site to ensure consistent quality.',
    },
    {
        title: 'Corporate Security',
        desc: 'Vetted, trained, and discreet staff for head offices, banks, and medical facilities.',
    },
    {
        title: 'Authentic Work',
        desc: 'Premium industrial equipment and chemicals. No hidden costs. No cutting corners.',
    },
];
    ...
    return (
        <>
            ...
            <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-slate-300 mb-10 max-w-2xl leading-relaxed font-light">
                                ...
                                <span className="text-white font-medium">Owner-supervised teams</span>{' '}
                ...
                {/* Scroll hint */}
                <motion.div
                    className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1 text-white/40 text-xs font-medium tracking-widest uppercase"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
            ...
            <section className="py-28 bg-white">
                <div className="container mx-auto px-6">
                    ...
                    <div className="text-center">
                        <Link
                            to="/services"
                            className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-full transition-all duration-300 group"
                        >
                            View Our Services
